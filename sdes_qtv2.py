...
from PyQt5.QtWidgets import QLabel, QLineEdit, QPushButton, QVBoxLayout, QWidget, QHBoxLayout, QFrame
...
class SDESApp(QWidget):
    ...
    def initUI(self):
        ...
        self.key_label.setFont(QtGui.QFont('Arial', 12))
        key_layout.addWidget(self.key_label)

        self.key_input = QLineEdit()
        self.key_input.setFont(QtGui.QFont('Arial', 12))
        ...
        self.plaintext_label = QLabel('8-bit Plaintext:')
        self.plaintext_label.setFont(QtGui.QFont('Arial', 12))
        plaintext_layout.addWidget(self.plaintext_label)

        self.plaintext_input = QLineEdit()
        self.plaintext_input.setFont(QtGui.QFont('Arial', 12))
        ...
        self.ciphertext_label.setFont(QtGui.QFont('Arial', 12))
        ciphertext_layout.addWidget(self.ciphertext_label)

        self.ciphertext_output = QLineEdit()
        self.ciphertext_output.setFont(QtGui.QFont('Arial', 12))
        ...
        self.decrypted_label.setFont(QtGui.QFont('Arial', 12))
        decrypted_layout.addWidget(self.decrypted_label)

        self.decrypted_output = QLineEdit()
        self.decrypted_output.setFont(QtGui.QFont('Arial', 12))
